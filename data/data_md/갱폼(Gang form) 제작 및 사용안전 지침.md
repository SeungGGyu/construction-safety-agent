...
(다) “상부케이지”라함은갱폼케이지의4단작업발판중거푸집설치․해체작업 용으로사용되는상부2단작업발판구성부분을말한다. (라) “하부케이지”라함은미장․치장(견출) 작업용으로사용되는하부2단작업발 판구성부분을말한다. (2) 기타이지침에서사용하는용어의정의는특별한규정이있는경우를제외하고 는산업안전보건법, 같은법시행령, 같은법시행규칙, 안전보건규칙및기타고 시에서정하는바에따른다.
